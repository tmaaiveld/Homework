...
par(mfrow=c(1,2))
plot(sumHarm(1:1000), col='turquoise', xlab='t',ylab='f(t)')
points(sumHarm(epsilon_power(1:1000)), col='skyblue')
points(sumHarm((1:1000)^2), add=TRUE, col='skyblue4')
curve((1.085*log(x)),add=TRUE)
...
plot(sumHarm((1:1000)^2)/log(1:1000), col='turquoise', xlab='t', ylab='f(t)/log(t)')
points(sumHarm(epsilon_power(1:1000))/log(1:1000), col='skyblue')
points(sumHarm(1:1000)/log(1:1000), add=TRUE, col='skyblue4')
lines(1)
rev(sumHarm(1:100000)/log(1:100000))[1]
